...
- 邮箱注册、登录、JWT 鉴权与个人画像
- 两步注册引导：账号信息之后立即补充校区、院系、兴趣、地点与社交方式
- 活动创建、查询、参与者和容量管理
...
app/
  ...
  post_activity.py  退出扣分、评价审核、第三人复核与隐藏画像学习
...
建议先用“小曾”体验已经结束的“昨晚南区羽毛球”，可以直接打开评价弹窗；提交“被放鸽子”等高影响评价后，切换“小李”即可看到第三人复核任务。也可以发起一次新匹配并邀请“小王”，再切换账号接受邀请。
...
10. 活动结束和评价定案后，画像 Agent 自动刷新不可由用户编辑的隐藏画像。
...
测试覆盖注册画像、无额度匹配、个性化需求、人工确认、单人发布、邀请响应、分时退出扣分、会后评价、第三人复核、隐藏画像、审计轨迹和关键越权拦截。
